...
<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed {{ Route::currentRouteName() == 'drivers.index' ? 'addBg' : '' }}"
                data-bs-target="#sellers" data-bs-toggle="collapse" href="#">
                <i class="bi bi-sliders"></i><span>{{ trans('lang.users') }}</span><i
        ...
        <li class="nav-item">
            <a class="nav-link collapsed {{ Route::currentRouteName() == 'companies.index' ? 'addBg' : '' }}"
                data-bs-target="#company" data-bs-toggle="collapse" href="#">
                <i class="bi bi-sliders"></i><span>{{ trans('lang.companies') }}</span><i
                    class="bi bi-chevron-down {{ app()->getLocale() == 'en' ? 'ms-auto' : 'me-auto' }}"></i>
            </a>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed {{ Route::currentRouteName() == 'passenger.index' ? 'addBg' : '' }}"
                data-bs-target="#passenger" data-bs-toggle="collapse" href="#">
                <i class="bi bi-sliders"></i><span>{{ trans('lang.passenger') }}</span><i
                    class="bi bi-chevron-down {{ app()->getLocale() == 'en' ? 'ms-auto' : 'me-auto' }}"></i>
            </a>
            <ul id="passenger" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                <li>
                    <a href="{{ route('passenger.index') }}">
                        <i class="bi bi-circle"></i><span>{{ trans('lang.passenger_list') }}</span>
                    </a>
                </li>
            </ul>
        </li>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed {{ Route::currentRouteName() == 'wallet.index' ? 'addBg' : '' }}"
                data-bs-target="#wallet" data-bs-toggle="collapse" href="#">
                <i class="bi bi-sliders"></i><span>{{ trans('lang.wallet') }}</span><i
                    class="bi bi-chevron-down {{ app()->getLocale() == 'en' ? 'ms-auto' : 'me-auto' }}"></i>
            </a>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed {{ Route::currentRouteName() == 'car_types.index' ? 'addBg' : '' }}"
                ...
                <i class="bi bi-sliders"></i><span>{{ trans('lang.car_type') }}</span><i
                    class="bi bi-chevron-down {{ app()->getLocale() == 'en' ? 'ms-auto' : 'me-auto' }}"></i>
            </a>
