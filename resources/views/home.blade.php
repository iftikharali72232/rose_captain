            ...
            <form action="{{ route('form.store') }}" method="POST">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="">
                            <input type="number" name="number_of_passengers" class="w-100 bg-gray p-2 border rounded"
                                required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="">
                            <input type="text" name="licence_plate_number" class="w-100 bg-gray p-2 border rounded"
                                required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="">
                            <input type="text" name="company_registration_number"
                                class="w-100 bg-gray p-2 border rounded" required>
                        </div>
                    </div>
