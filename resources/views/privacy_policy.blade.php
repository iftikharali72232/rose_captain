     ...
     <div class="container mt-4">
        <div class="card shadow-sm border-0 p-4">
            <div class="card-body">
                ...
                <p>We may collect personal information such as your name, email, phone number, location data, and any other data you provide through forms on our website.</p>

                <h4 class="mt-4">3. Location Data</h4>
                <p>We may collect and process your location data to provide personalized services, such as:</p>
                <ul>
                    <li>Improving user experience by showing relevant content based on your location</li>
                    <li>Providing location-based services such as maps or nearby recommendations</li>
                    <li>Enhancing security and fraud detection</li>
                </ul>
                <p>You can enable or disable location services through your device settings.</p>

                <h4 class="mt-4">4. How We Use Your Information</h4>
                <ul>
                ...
                <h4 class="mt-4">6. Third-Party Sharing</h4>
